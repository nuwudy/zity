            ...
            <form id="loginBox" method="POST" action="{{ route('login.post') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" required placeholder="••••••••" class="w-full pl-10 pr-3.5 py-3 text-sm rounded-2xl border border-slate-200 focus:border-purple-600 focus:ring-4 focus:ring-purple-100 outline-none transition bg-slate-50/50">
                    </div>
                </div>
            ...
            <form id="registerBox" method="POST" action="{{ route('register.post') }}" class="space-y-4 hidden">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="password" name="password" required placeholder="••••••••" class="w-full px-3.5 py-2.5 text-sm rounded-2xl border border-slate-200 focus:border-purple-600 focus:ring-4 focus:ring-purple-100 outline-none transition bg-slate-50/50">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-slate-700 mb-1.5">Confirm</label>
                        <input type="password" name="password_confirmation" required placeholder="••••••••" class="w-full px-3.5 py-2.5 text-sm rounded-2xl border border-slate-200 focus:border-purple-600 focus:ring-4 focus:ring-purple-100 outline-none transition bg-slate-50/50">
                    </div>
                </div>

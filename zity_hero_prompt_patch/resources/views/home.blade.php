    ...
    <section class="relative pt-32 pb-20 px-6 overflow-hidden">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
            <div class="flex-1 text-center md:text-left">
                ...
                <!-- ── Shop Owner / Service Provider Prompt ── -->
                <a href="#register" class="block mb-5 p-4 bg-indigo-600 rounded-2xl text-white hover:bg-indigo-700 active:scale-95 transition-all shadow-lg shadow-indigo-200 group">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center text-xl flex-shrink-0">🏪</div>
                            <div class="text-left">
                                <p class="font-bold text-sm leading-tight">Shop Owner or Service Provider?</p>
                                <p class="text-indigo-200 text-xs mt-0.5">Register free — appear in search results instantly</p>
                            </div>
                        </div>
                        <div class="flex-shrink-0 bg-white text-indigo-600 text-xs font-bold px-3 py-1.5 rounded-xl group-hover:scale-105 transition-transform">
                            Register Free →
                        </div>
                    </div>
                </a>
                ...
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <span class="text-xs font-semibold text-gray-400 uppercase tracking-widest">Or check your brand name</span>
                    <div class="flex-1 h-px bg-gray-200"></div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                    ...
                    <a href="#register" class="w-full sm:w-auto px-8 py-4 bg-indigo-600 text-white rounded-2xl font-bold text-lg hover:bg-indigo-700 transition-all text-center shadow-lg shadow-indigo-200">Register Your Business →</a>
                </div>
            </div>
